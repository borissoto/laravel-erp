<div wire:loading>
    <div style="display: flex; justify-content: center; align-items: center; background-color: black; position: fixed; top: 0px; left:0px; z-index: 9999; width: 100%; height: 100%; opacity: .60;">
        <div style="color: #91dcff" class="la-ball-atom la-3x">
            <div></div>
            <div></div>
            <div></div>
            <div></div>
