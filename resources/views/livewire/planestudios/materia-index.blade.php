            ...
            <div class="card-body">
                <table width="100%" class="table table-sm table-bordered table-striped text-sm">
                    ...
                    @forelse($rows as $row)<tr> 
                        <td>{{ $row->residencia->gestion_ini.' ('.$row->residencia->nom_residencia.')' }}</td>
                        <td>{{ $row->residencia->departamento->nom_departamento }}</td>
                        <td>{{ $row->residencia->nivel }}</td>
                        <td>{{ $row->modulo}}</td>
                        ...
                        <td>
                            ...
                            <a class="text-primary" href="{{ route('planestudios.materia.estudiantes', $row->id)}}">
                    ...
                    </tr>@empty  <tr><td>0 Registros Econtrados</td></tr>   @endforelse
