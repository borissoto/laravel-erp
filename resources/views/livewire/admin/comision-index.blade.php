                            ...
                            <table id="example1" class="table table-sm table-bordered table-striped text-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">{{ $comision->cite}}</td> 
                                        ...
                                        <td width="20px">
                                            ...
                                            {{-- <a class="dropdown-item" wire:click="showModal({{$user->id}})"  href="javascript:void(0">Ver</a> --}}
                                                <a class="dropdown-item" wire:click.prevent="edit({{ $comision->id }})"  href="">Editar</a>                                       
                                                <a class="dropdown-item" wire:click.prevent="sendPrint({{ $comision->id }})"  href="">Imprimir</a>                                       
