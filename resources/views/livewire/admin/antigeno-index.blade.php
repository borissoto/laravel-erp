            ...
            <div class="card">
                ...
                <div class="card-body pb-1">
                    {{-- <div class="table-responsive"> --}}
                        ...
                        <tbody>
                            @foreach ($antigenos as $antigeno) 
                            <tr>
                                {{-- <td>{{ $user->firstItem()+$loop->index}}</td> --}}
                                <td>{{ $antigeno->municipio->departamento->nom_departamento}}</td>
                                <td>{{ $antigeno->municipio->nom_municipio}}</td>
                                <td>{{ $antigeno->prueba}}</td>
                                <td>{{ $antigeno->tipo}}</td>
                                <td>{{ $antigeno->muestras}}</td>
                                <td>{{ $antigeno->positivos}}</td>                              
                                <td width="20px">
                                    <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="min-width: 1rem;"  role="menu">                                        
                                        <a class="dropdown-item" href="{{route('role.edit', $antigeno)}}">Editar</a>
                                    </div>
                                    </div>
                        ...
                        <div class="d-flex justify-content-start text-muted">
                            Mostrando {{ $antigenos->firstItem() }} to {{ $antigenos->lastItem() }} de {{$antigenos->total()}} registros.
                        </div>                                     
                    {{-- </div> --}}
                </div>
