                      ...
                      <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <span > {!! $user->estado === 1 ? '<span class="badge bg-success">Activo</span>' : '<span class="badge bg-danger">Inactivo</span>' !!}</span>                              
                              </div>                                                       
                            </div>   
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                              <label for="ap-paterno" class="col-sm-2 col-form-label">Ap Paterno</label>
                              <div class="col-sm-4">
                                <input class="form-control" type="text" disabled value="{{ $user->ap_paterno}}" id="ap-paterno">
                              </div>                            
                              <label for="ap-materno" class="col-sm-2 col-form-label">Ap Materno</label>
                              <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="extension" class="col-sm-2 col-form-label">Exp</label>
                              <div class="col-sm-4" >
                                <input class="form-control" type="text" disabled value="{{ $user->departamento->abreviatura }}" id="extension">
                              </div>                                                  
                            </div>                                                
                            <div class="form-group row">
                                <label for="fechanac" class="col-sm-2 col-form-label">Fecha Nac</label>                                                                                                  
                                <div class="col-sm-4"> 
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-2 col-form-label">Titulacion</label>
                                <div class="col-sm-4">
