                        ...
                        {{-- <div class="table-responsive"> --}}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $municipio->id}}</td>
                                    <td class="align-middle">{{ $municipio->departamento->nom_departamento}}</td>
                                    <td class="align-middle">{{ $municipio->cod_red}}</td>                                                     
                                    <td class="align-middle">{{ $municipio->nom_provincia}}</td>                                                     
                                    <td class="align-middle">{{ $municipio->nom_municipio}}</td>                                                     
                                    <td class="align-middle">{{ $municipio->cod_municipio}}</td> 
