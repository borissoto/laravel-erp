<div wire:ignore.self class="modal fade" id="eessUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           <div class="modal-body">
                <form >                  
                    ...
                    <div class="form-group row" wire:ignore>
                        ...
                        <div class="col-md-4">
                            <input wire:model="lat" type="text" class="form-control form-control-sm" name="lat" id="latEdit"  placeholder=" Arrastre el marcador Rojo" min="-9.662687" max="-22.908152" title="Debe ingresar latitud correspondiente a Bolivia" disabled>
                            
                        </div>
                        <label class="col-md-2 col-form-label col-form-label-sm">Longitud</label>
                        <div class="col-md-4">
                            <input wire:model="long" type="text" class="form-control form-control-sm" name="long" id="longEdit" placeholder="Arrastre el marcador Rojo" min="-57.452675" max="-69.626293" title="Debe ingresar Longitud correspondiente a Bolivia" disabled>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="updateEstablecimiento()" class="btn btn-primary close-modal">Guardar</button>
            </div>
        </div>
    </div>
</div>
