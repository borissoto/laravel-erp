<div wire:ignore.self class="modal fade" id="comisionCreate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="min-height: 560px">
           ...
           <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="storeComision()" class="btn btn-primary close-modal">Guardar </button>
