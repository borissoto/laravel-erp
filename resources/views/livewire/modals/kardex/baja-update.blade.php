<div wire:ignore.self class="modal fade" id="kardexBajaUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="min-height: 560px">
           ...
           <div class="modal-body">
            <div class="col-md-12">
                <div class="card card-primary card-outline card-outline-tabs">
                  ...
                  <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <input type="hidden" wire:model="baja_id">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="updateBaja()" class="btn btn-primary close-modal">Guardar </button>
