<div wire:ignore.self class="modal fade" id="kardexSupervisionUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" style="min-height: 560px">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Editar Supervision</h5>
           ...
           <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="updateSupervision()" class="btn btn-primary close-modal">Guardar </button>
