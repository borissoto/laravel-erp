           ...
           <div class="modal-dialog" role="document">
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                        ...
                        <div class='form-group'><label for='marca'>Marca</label>                            
                            <select wire:model='marca' id="marca" class="form-control">
                                <option value="">Marca de Vacuna</option>
                        ...
                        <div class='form-group'><label for='dosis1'>Dosis1</label>
                            <input type='number' class='form-control @error('dosis1')  is-invalid @enderror' wire:model='dosis1'>
                            @error('dosis1')<div class='invalid-feedback'>{{ $message }}</div>@enderror
                        </div>
                        <div class='form-group'><label for='dosis2'>Dosis2</label>
                            <input type='number' class='form-control @error('dosis2')  is-invalid @enderror' wire:model='dosis2'>
                            @error('dosis2')<div class='invalid-feedback'>{{ $message }}</div>@enderror
                        </div>
                        <div class='form-group'><label for='esavis'>Esavis</label>
                            <input type='number' class='form-control @error('esavis')  is-invalid @enderror' wire:model='esavis'>
                            @error('esavis')<div class='invalid-feedback'>{{ $message }}</div>@enderror
                        </div>
