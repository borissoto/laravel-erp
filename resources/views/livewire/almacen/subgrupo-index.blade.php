...
<div class='form-group'><label for='alm_partida_id'>Alm partida id</label>
    <input type='text' class='form-control @error('alm_partida_id')  is-invalid @enderror' wire:model='alm_partida_id'>@error('alm_partida_id')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
