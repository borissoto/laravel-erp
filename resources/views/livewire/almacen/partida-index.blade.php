...
<div class='form-group'><label for='detalle'>Detalle</label><input type='text' class='form-control @error('detalle')  is-invalid @enderror' wire:model='detalle'>@error('detalle')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
<div class='form-group'><label for='numero'>Numero</label><input type='text' class='form-control @error('numero')  is-invalid @enderror' wire:model='numero'>@error('numero')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
<div class='form-group'><label for='partida'>Partida</label><input type='text' class='form-control @error('partida')  is-invalid @enderror' wire:model='partida'>@error('partida')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
...
<div class='form-group'><label for='vigente'>Vigente</label><input type='text' class='form-control @error('vigente')  is-invalid @enderror' wire:model='vigente'>@error('vigente')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
