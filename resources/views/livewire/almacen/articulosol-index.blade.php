<div>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="text-success" wire:click.prevent="selectedArticulo({{ $row->id }})"> 
                                            {{-- <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-check-square" viewBox="0 0 16 16" stroke="green" stroke-width="2" stroke-linecap="round"> --}}
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-arrow-down-square" viewBox="0 0 16 16" stroke-width="2" stroke-linecap="round">
    ...
    {{--    create / edit form --}}
       ...
       <div class="modal fade" wire:ignore.self id="solarticuloAdd" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="showFormLabel" aria-hidden="true">
