            ...
            <div class="card-body">
                <table width="100%" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        {{-- <th>ALM ARTICULO ID</th> --}}

<th>CANTIDAD</th>

{{-- <th>ALM COMPROBANTE ID</th> --}}
...
<th>PRECIO UNITARIO</th>
                    ...
                    <tbody>
                    @forelse($rows as $row)
{{-- <tr> <td>{{ $row->alm articulo id}}</td> --}}

 <td>{{ $row->cantidad}}</td>

 {{-- <td>{{ $row->alm comprobante id}}</td> --}}
...
<div class='form-group'><label for='alm_comprobante_id'>Alm comprobante id</label><input type='text' class='form-control @error('alm_comprobante_id')  is-invalid @enderror' wire:model='alm_comprobante_id'>@error('alm_comprobante_id')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
<div class='form-group'><label for='fecha_venc'>Fecha venc</label><input type='text' class='form-control @error('fecha_venc')  is-invalid @enderror' wire:model='fecha_venc'>@error('fecha_venc')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
...
<div class='form-group'><label for='valor_total'>Valor total</label><input type='text' class='form-control @error('valor_total')  is-invalid @enderror' wire:model='valor_total'>@error('valor_total')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
<div class='form-group'><label for='precio_unitario'>Precio unitario</label><input type='text' class='form-control @error('precio_unitario')  is-invalid @enderror' wire:model='precio_unitario'>@error('precio_unitario')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
