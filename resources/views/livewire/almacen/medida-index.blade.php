           ...
           <div class="modal-dialog" role="document">
               <div class="modal-content">
                   <div class="modal-header">
                       <h5 class="modal-title" id="showFormLabel"> {{ $mode == 'create' ? 'Nueva Unidad de Medida' : 'Actualizr Unidad de Medida ' }}</h5>
...
<div class='form-group'><label for='abrev'>Abrev</label><input type='text' class='form-control @error('abrev')  is-invalid @enderror' wire:model='abrev'>@error('abrev')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
