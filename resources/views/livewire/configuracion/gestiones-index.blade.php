           ...
           <div class="modal-dialog" role="document">
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                        <div class='form-group'><label for='gestion'>Gestion</label><input type='text' class='form-control @error('gestion')  is-invalid @enderror' wire:model='gestion'>@error('gestion')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
<div class='form-group'><label for='is_active'>Is active</label><input type='text' class='form-control @error('is_active')  is-invalid @enderror' wire:model='is_active'>@error('is_active')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
