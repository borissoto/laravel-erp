           ...
           <div class="modal-dialog" role="document">
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                        <div class='form-group'><label for='nom_unidad'>Nom unidad</label><input type='text' class='form-control @error('nom_unidad')  is-invalid @enderror' wire:model='nom_unidad'>@error('nom_unidad')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
<div class='form-group'><label for='sigla'>Sigla</label><input type='text' class='form-control @error('sigla')  is-invalid @enderror' wire:model='sigla'>@error('sigla')<div class='invalid-feedback'>{{ $message }}</div>@enderror</div>
