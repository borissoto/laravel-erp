<div>
        ...
        <div class="row mb-6">
          <div class="col-sm-8">
            <h1>
              ...
              <span class=" text-lg"> - Salidas de Almacenes</span>
    ...
    <nav class="navbar navbar-expand-md mb-4 shadow" style="background-color: #daf0ff;">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item" >
            <a class="nav-link " href="{{ route('almacen.sal.solicitudes')}}">Solicitudes </a>
          </li>
          <li class="nav-item" style="background-color: rgb(73, 131, 185); border-radius: 4px;">
            <a class="nav-link text-light" href="{{route('almacen.sal.entregados')}}">Entregados <span class="sr-only">(current)</span> </a>
          </li>
          <li class="nav-item">
    ...
    @livewire('almacen.entregado-index' )
