      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item" style="background-color: rgb(73, 131, 185); border-radius: 4px;">
            <a class="nav-link text-light" href="{{route('cuadernos.c10f')}}">C10F</a>
          </li>   
          <li class="nav-item">
            <a class="nav-link" href="{{route('cuadernos.c11')}}">C11</a>
          </li>   
          <li class="nav-item">
            <a class="nav-link" href="{{route('cuadernos.c12')}}">C12</a>
          </li>   
