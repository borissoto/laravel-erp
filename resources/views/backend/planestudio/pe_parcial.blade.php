<div>
        ...
        <div class="row mb-6">
          <div class="col-sm-8">
            <h1>
              ...
              <span class=" text-lg"> - Evaluaciones</span>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item" style="background-color: rgb(73, 131, 185); border-radius: 4px;">
            <a class="nav-link text-light" href="{{route('planestudios.evaluaciones')}}">Evaluaciones</a>
          </li>   
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6" >
                    @livewire('plan-estudios.curso-select' )
                </div>
                <div class="col-md-0">
                ...
                <div class="col-md-6">
                    @livewire('plan-estudios.parcial-index' )
                </div>
            </div>
