<div>
        ...
        <div class="row mb-6">
          <div class="col-sm-8">
            <h1>
              ...
              <span class=" text-lg"> - Residentes</span>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item" style="background-color: rgb(73, 131, 185); border-radius: 4px;">
            <a class="nav-link text-light" href="{{ route('planestudios.residentes')}}">Residentes </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('planestudios.matriculaciones')}}">Matriculaciones</a>
          </li>
        </ul>
    ...
    @livewire('plan-estudios.residente-index' )
