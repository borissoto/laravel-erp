  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item" style="background-color: rgb(73, 131, 185); border-radius: 4px;">
        <a class="nav-link text-light" href="{{route('rrhh.kardex.supervision', $user->id)}}">Supervision <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
@livewire('admin.kardex-supervision', ['user'=>$user])
